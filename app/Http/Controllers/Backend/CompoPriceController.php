        ...
        if (request()->ajax()) {
            ...
            return datatables()->of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<a class="edit-compo-price btn btn-sm btn-success" data-path="' . route('compo_price.edit', ['username' => request()->segment(1),  'compo_price' => $row->id]) . '" title="Edit" style="margin-right: 5px;">
