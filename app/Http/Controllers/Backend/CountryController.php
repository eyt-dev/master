        ...
        if (request()->ajax()) {
            ...
            return datatables()->of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<a class="edit-country btn btn-sm btn-success" data-path="' . route('country.edit',['username' => request()->segment(1),  'country' => $row->id]) . '" title="Edit" style="margin-right: 5px;">
