        ...
        if (request()->ajax()) {
            ...
            return datatables()->of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $buttons .= '<a class="edit-element btn btn-sm btn-success" data-path="' . route('element.edit', ['username' => request()->segment(1),  'element' => $row->id]) . '" title="Edit" style="margin-right: 5px;">
