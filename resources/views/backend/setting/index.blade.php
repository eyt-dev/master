    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{route('setting.create', ['username' => $siteSlug])}}" id="add_new" class="btn btn-info" data-toggle="tooltip" title="Add new">
...
@section('js')
    ...
    <script>
        ...
        var table = $('#setting_table').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('setting.index', ['username' => $siteSlug]) }}",
            columns: [
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        url: "{{ route('setting.destroy', ['username' => $siteSlug, 'setting' => ':id']) }}".replace(':id', id),
                        success: function(response) {
