<aside class="app-sidebar ps ps--active-y">
	...
	<div class="app-sidebar__user">
		<div class="dropdown user-pro-body text-center">
			<div class="user-pic">
				<img src="{{Auth::user()->image ? asset('storage/' . Auth::user()->image) : URL::asset('assets/images/users/2.jpg')}}" alt="user-img" class="avatar-xl rounded-circle mb-1">
			</div>
			<div class="user-info">
            ...
            @can('view.material_stock')
                <li class="slide">
                    <a class="side-menu__item" href="{{route('material-stock.index', ['username' => $siteSlug])}}">
                        ...
                        <span class="side-menu__label">Feed Stock</span></a>
                </li>
            @endcan
