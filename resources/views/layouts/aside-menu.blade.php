<aside class="app-sidebar ps ps--active-y">
    ...
    <div class="app-sidebar__user">
        <div class="dropdown user-pro-body text-center">
            ...
            <div class="user-info">
                <h5 class=" mb-1">{{Str::title(auth()->user()->name)}} <i
    ...
    <ul class="side-menu app-sidebar3">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{url('/setting')}}">
                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                        ...
                        <path
                            d="M16.66 4.52l2.83 2.83-2.83 2.83-2.83-2.83 2.83-2.83M9 5v4H5V5h4m10 10v4h-4v-4h4M9 15v4H5v-4h4m7.66-13.31L11 7.34 16.66 13l5.66-5.66-5.66-5.65zM11 3H3v8h8V3zm10 10h-8v8h8v-8zm-10 0H3v8h8v-8z"></path>
                    </svg>
        ...
        @canany(['view.country','view.unit','view.element'])
            ...
            @can('view.country')
                <li class="slide">
                    <a class="side-menu__item" href="{{route('country.index')}}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                             width="24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                            <path
            ...
            @can('view.page')
                <li class="slide">
                    <a class="side-menu__item" href="{{route('element.index')}}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                             width="24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                            <path
        ...
        @canany(['view.component','view.compo_price'])
            ...
            @can('view.component')
                <li class="slide">
                    <a class="side-menu__item" href="{{route('component.index')}}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                             width="24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                            <path
            ...
            @can('view.compo_price')
                <li class="slide">
                    <a class="side-menu__item" href="{{route('compo_price.index')}}">
                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                             width="24">
                            <path d="M0 0h24v24H0V0z" fill="none"/>
                            <path
