	...
	<div class="container-fluid">
		<div class="d-flex">
			<a class="header-brand" href="{{url('/' . $page='index')}}">
				...
				<img src="{{URL::asset('assets/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="EYT logo">
				<img src="{{URL::asset('assets/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="EYT logo">
			</a>
...
{{--                                        </div>--}}
				...
				<div class="dropdown profile-dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
						...
						<a class="dropdown-item d-flex" href="{{url('e/profile/'.Auth::id())}}">
						...
						<a class="dropdown-item d-flex" href="{{route('setting.index', ['username' => request()->get('username', $siteSlug)])}}">
						...
						<form id="logout-form" action="{{ route('logout', ['username' => $siteSlug]) }}" method="POST" class="d-none">@csrf</form>
					</div>
				</div>
			</div>
		</div>
