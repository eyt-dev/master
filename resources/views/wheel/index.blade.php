    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a id="add_new_wheel" class="btn btn-info" href="{{ route('wheel.create') }}" data-toggle="tooltip" title="Add new">
            ...
            $(document).on('click', '.delete-wheel', function() {
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('wheel.destroy', ':id') }}".replace(':id', id),
