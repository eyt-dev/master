...
use App\Http\Controllers\Api\Add2Farm\FlockEndMaintenanceController as Add2FarmFlockEndMaintenanceController;
...
Route::prefix('add2farm')->middleware(['reject.password.reset.token', 'set.add2farm.language', 'convert.european.numbers'])->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'check.admin.type:0,1,2,3'])->group(function () {
        ...
        Route::get('flock-ends/last-net-weights/{flock_id}/{hangar_id}', [Add2FarmFlockEndController::class, 'getLastNetWeights']);
    });
    ...
    // These routes synchronize data based on requirements
